 ...
 * tags, inputs, the actions menu, etc.) read as part of the same "CrediTrack"
 * identity instead of Aura's default emerald green. Everything
 ...
 * styles.scss does.
 */
export const CreditTrackPreset = definePreset(Aura, {
  semantic: {
    primary: {
      50: '#EFF4FD',
      100: '#DCE7FB',
